...
const PLAN_LANGUAGE_OPTIONS = { mode: { type: "string", enum: ["outline", "flow", "semantic", "full"] }, detail: { type: "string", enum: ["compact", "expanded", "lossless-references", "raw-linked"] }, redaction: { type: "string", enum: ["none", "standard", "strict"] }, subtreeNodeId: NON_EMPTY_STRING, nodeId: NON_EMPTY_STRING, depth: INTEGER, format: { type: "string", enum: ["object", "json", "yaml"] } };
...
export const QUERY_TOOL_INPUT_SCHEMAS: Record<string, JsonSchema> = {
  find_nodes: objectSchema({ ...PLAN_ID, role: NON_EMPTY_STRING, type: NON_EMPTY_STRING, name: NON_EMPTY_STRING, path: NON_EMPTY_STRING, enabled: BOOLEAN, match: { type: "string", enum: ["contains", "exact", "regex", "fuzzy"] }, view: { type: "string", enum: ["compact", "full", "raw"] }, variable: NON_EMPTY_STRING, method: NON_EMPTY_STRING, requestPath: NON_EMPTY_STRING, pathContains: NON_EMPTY_STRING, domain: NON_EMPTY_STRING, domainContains: NON_EMPTY_STRING, pluginClass: NON_EMPTY_STRING, parentNodeId: NON_EMPTY_STRING, parentRole: NON_EMPTY_STRING, parentType: NON_EMPTY_STRING, parentName: NON_EMPTY_STRING, childRole: NON_EMPTY_STRING, childType: NON_EMPTY_STRING, childName: NON_EMPTY_STRING, field: NON_EMPTY_STRING, fieldValue: NON_EMPTY_STRING, ...PAGE_OPTIONS, nodeId: NON_EMPTY_STRING }, ["planId"]), find_by_variable: objectSchema({ ...PLAN_ID, variable: NON_EMPTY_STRING }, ["planId", "variable"]), find_by_request: objectSchema({ ...PLAN_ID, method: NON_EMPTY_STRING, path: NON_EMPTY_STRING, pathContains: NON_EMPTY_STRING, domain: NON_EMPTY_STRING, domainContains: NON_EMPTY_STRING }, ["planId"]), find_disabled_nodes: objectSchema(PLAN_ID, ["planId"]), explain_execution_flow: objectSchema(PLAN_ID, ["planId"])
};
