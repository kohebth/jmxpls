...
export const QUERY_TOOL_INPUT_SCHEMAS: Record<string, JsonSchema> = {
  find_nodes: objectSchema({ ...PLAN_ID, role: NON_EMPTY_STRING, type: NON_EMPTY_STRING, name: NON_EMPTY_STRING, enabled: BOOLEAN }, ["planId"]),
  find_by_variable: objectSchema({ ...PLAN_ID, variable: NON_EMPTY_STRING }, ["planId", "variable"]),
  find_by_request: objectSchema({ ...PLAN_ID, method: NON_EMPTY_STRING, path: NON_EMPTY_STRING, pathContains: NON_EMPTY_STRING, domain: NON_EMPTY_STRING, domainContains: NON_EMPTY_STRING }, ["planId"]),
...
export const MUTATION_TOOL_INPUT_SCHEMAS: Record<string, JsonSchema> = {
  add_node: objectSchema({ ...PLAN_ID, ...PARENT_ID, nodeType: NON_EMPTY_STRING, type: NON_EMPTY_STRING, fields: OBJECT, index: INTEGER, ...PATCH_FLAGS }, ["planId"], { allOf: [PARENT_ONE_OF, { anyOf: [{ required: ["nodeType"] }, { required: ["type"] }] }] }),
  update_node_field: objectSchema({ ...PLAN_ID, ...NODE_ID, fieldPath: NON_EMPTY_STRING, field: NON_EMPTY_STRING, value: ANY, ...PATCH_FLAGS }, ["planId", "nodeId"], { anyOf: [{ required: ["fieldPath"] }, { required: ["field"] }] }),
  delete_node: objectSchema({ ...PLAN_ID, ...NODE_ID, ...PATCH_FLAGS }, ["planId", "nodeId"]),
  move_node: objectSchema({ ...PLAN_ID, ...NODE_ID, toParentNodeId: NON_EMPTY_STRING, ...PARENT_ID, index: INTEGER, ...PATCH_FLAGS }, ["planId", "nodeId"], { anyOf: [{ required: ["toParentNodeId"] }, { required: ["parentNodeId"] }, { required: ["parentId"] }] }),
  clone_node: objectSchema({ ...PLAN_ID, ...NODE_ID, toParentNodeId: NON_EMPTY_STRING, ...PARENT_ID, index: INTEGER, ...PATCH_FLAGS }, ["planId", "nodeId"], { anyOf: [{ required: ["toParentNodeId"] }, { required: ["parentNodeId"] }, { required: ["parentId"] }] }),
  enable_node: objectSchema({ ...PLAN_ID, ...NODE_ID }, ["planId", "nodeId"]),
  disable_node: objectSchema({ ...PLAN_ID, ...NODE_ID }, ["planId", "nodeId"]),
  apply_semantic_patch: objectSchema({ ...PLAN_ID, patch: OBJECT, operations: ARRAY, ...PATCH_FLAGS }, ["planId"], { anyOf: [{ required: ["patch"] }, { required: ["operations"] }] })
};

export const HTTP_TOOL_INPUT_SCHEMAS: Record<string, JsonSchema> = {
  add_http_request: objectSchema({ ...PLAN_ID, ...PARENT_ID, ...HTTP_TARGET_FIELDS, method: NON_EMPTY_STRING, body: NON_EMPTY_STRING, headers: OBJECT, ...POSITION_AND_FLAGS }, ["planId"], PARENT_ONE_OF),
  add_http_defaults: objectSchema({ ...PLAN_ID, ...PARENT_ID, ...HTTP_TARGET_FIELDS, ...POSITION_AND_FLAGS }, ["planId"], PARENT_ONE_OF),
  add_header_manager: objectSchema({ ...PLAN_ID, ...PARENT_ID, name: NON_EMPTY_STRING, headers: OBJECT, ...POSITION_AND_FLAGS }, ["planId"], PARENT_ONE_OF),
  add_cookie_manager: objectSchema({ ...PLAN_ID, ...PARENT_ID, name: NON_EMPTY_STRING, ...POSITION_AND_FLAGS }, ["planId"], PARENT_ONE_OF),
  add_cache_manager: objectSchema({ ...PLAN_ID, ...PARENT_ID, name: NON_EMPTY_STRING, ...POSITION_AND_FLAGS }, ["planId"], PARENT_ONE_OF),
  add_auth_manager: objectSchema({ ...PLAN_ID, ...PARENT_ID, name: NON_EMPTY_STRING, ...POSITION_AND_FLAGS }, ["planId"], PARENT_ONE_OF)
};

export const DATA_TOOL_INPUT_SCHEMAS: Record<string, JsonSchema> = {
  add_user_variables: objectSchema({ ...PLAN_ID, ...PARENT_ID, name: NON_EMPTY_STRING, variables: OBJECT, ...POSITION_AND_FLAGS }, ["planId"], PARENT_ONE_OF),
  add_csv_data_set: objectSchema({ ...PLAN_ID, ...PARENT_ID, name: NON_EMPTY_STRING, filename: NON_EMPTY_STRING, variableNames: ARRAY, delimiter: NON_EMPTY_STRING, ignoreFirstLine: BOOLEAN, recycle: BOOLEAN, stopThread: BOOLEAN, shareMode: NON_EMPTY_STRING, ...POSITION_AND_FLAGS }, ["planId", "filename"], PARENT_ONE_OF),
  add_counter: objectSchema({ ...PLAN_ID, ...PARENT_ID, name: NON_EMPTY_STRING, variableName: NON_EMPTY_STRING, start: STRING_OR_NUMBER, end: STRING_OR_NUMBER, increment: STRING_OR_NUMBER, format: NON_EMPTY_STRING, perUser: BOOLEAN, resetOnThreadGroupIteration: BOOLEAN, ...POSITION_AND_FLAGS }, ["planId", "variableName"], PARENT_ONE_OF),
