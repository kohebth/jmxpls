...
const PLAN_LANGUAGE_OPTIONS = { mode: { type: "string", enum: ["outline", "flow", "semantic", "full"] }, detail: { type: "string", enum: ["compact", "expanded", "lossless-references", "raw-linked"] }, redaction: { type: "string", enum: ["none", "standard", "strict"] }, subtreeNodeId: NON_EMPTY_STRING, nodeId: NON_EMPTY_STRING, format: { type: "string", enum: ["object", "json", "yaml"] } };
